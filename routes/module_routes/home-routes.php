...
Route::get('/payroll-home'              ,[HomeController::class, 'payroll'                         ])->name('payroll-home')->middleware('checkUserRole:1,2');
Route::get('/generated-payroll'         ,[HomeController::class, 'generatedPayroll'                ])->name('generated')->middleware('checkUserRole:1,2');
