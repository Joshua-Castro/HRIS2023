function adminDashboard() {
    return {
        ...
        uploadFile : function (employeeId) {
            ...
            const pond = FilePond.create(inputElement, { // INITIALIZE FILEPOND
                allowMultiple: true,
                server: {
                    process: {
            ...
            pond.on('processfile', (error, file) => {
                console.log(file.id); // UNIQUE FILE ID GENERATED BY THE FILEPOND
            ...
            // Add an event listener for the remove event
